...
let gridClass = new gridData();

gridClass.buildElements(data['data']);
gridClass.getHeight();
console.log($("#grid"));


//gridData._init();
//gridData.buildElements(data['data']);

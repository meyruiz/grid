    ...
    DraggableGridList.prototype = {
        ...
        _calculateCellSize: function () {
            if (this.options.direction === "horizontal") {
                ...
                this._cellHeight = Math.floor(20 / zoomScale);
                //this.$element.height() / this.options.height / zoomScale / this.options.widthHeightRatio;
            }
            if (this.options.heightToFontSizeRatio) {
                this._fontSize = this._cellHeight / this.options.heightToFontSizeRatio / 5;
            }
        },
        ...
        _getItemHeight: function(item) {
            return Math.floor((item.h * this._cellHeight) / 12); // turn inches to ft
        },
        ...
        _applyPositionToItems: function () {
            ...
            for (var i = 0; i < this.items.length; i++) {
                ...
                this.items[i].$element.css({
                    ...
                    top: (this.items[i].y * this._cellHeight) / 12
                });
            }

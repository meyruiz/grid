#pragma checksum "/Users/mruiz/Documents/Epicor/grid/WebApplication3/Pages/Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "2c2e71a0582ca8218301ce6ce110e84ccc582785"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"2c2e71a0582ca8218301ce6ce110e84ccc582785", @"/Pages/Index.cshtml")]
...
");
            WriteLiteral("            </div>\r\n        </div>\r\n    </div>\r\n    ");
            EndContext();
            BeginContext(2171, 3717, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "37370e42b5cd4df8844d543ed0a1bec5", async() => {
                BeginContext(2177, 3704, true);
                WriteLiteral(@"
        <div id=""scale"">
            <p>Scale</p>
            <p>2' x 1.00""</p>
        ...
        function changeZoom(a) {
            ...
            if ((zoom != 7 && a != 1) || (zoom != 14 && a != -1)) {
                ...
                tooltips.forEach(tooltip => {
                    tooltip.style.fontSize = `${fontSize * (Number(zoom) / 10)}em`;
                    tooltip.style.width = `${width * (Number(zoom) / 10)}px`;
                    tooltip.style.height = `${height * (Number(zoom) / 10)}px`;
                });
   ");
            WriteLiteral(@"         }
        }
        ...
        function PrintElem() {
            ...
            mywindow.document.write('<h1>' + documen");
            WriteLiteral(@"t.title + '</h1>');

#pragma checksum "C:\Users\mayra.ruiz\OneDrive - Epicor\Documents\grid\WebApplication3\Pages\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "bed5cf5c6f7af0a3402ae8c8d1a3e59f5c80fd84"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"bed5cf5c6f7af0a3402ae8c8d1a3e59f5c80fd84", @"/Pages/Index.cshtml")]
...
<div id=""dialog"" title=""Cell Settings"">
    ...
    <div>
        <button type=""button"" class=""btn add-horizontal-offcut"" href=""#add-horizontal-offcut"" style=""margin-bottom:15px;"" data-toggle=""modal"" data-target=""#offcutCost"">Horizontal Offcut</button>
        <button type=""button"" class=""btn add-vertical-offcut"" href=""#add-vertical-offcut"" style=""margin-bottom:15px;"" data-toggle=""modal"" data-target=""#offcutCost"">Vertical Offcut</button>
    </div>
</div>
    ...
    <div class=""modal-dialog"" role=""doc");
        ...
        <div class=""modal-content"">
            <div class=""modal-header"">
                <h5 class=""modal-title"" id=""exampleModalLabel"">Calculate Cost</h5>
...
<!-- Modal -");
            WriteLiteral(@"->
<div class=""modal fade"" id=""offcutCost"" tabindex=""-1"" role=""dialog"" aria-labelledby=""offcutCostLabel"" aria-hidden=""true"">
    <div class=""modal-dialog modal-lg"" role=""document"">
        <div class=""modal-content"">
            ...
            <div class=""modal-body"">
                <p>Item ID: <input id=""itemId"" type=""text"" name=""itemId""><input id=""itemName"" type=""text"" name=""itemName""></p>
                <p>Remnant (L x M): <input id=""height"" type=""text"" name=""height""> <input id=""width"" type=""text"" name=""width""> </p>

                <p>Cut (L x M): <input id=""itemDimensions"" type=""text"" name=""itemDimensions""> Total Cut Cost: $<input id=""cutCost"" type=""text"" name=""cutCost""> <input id=""cutPerc");
            WriteLiteral(@"entage"" type=""text"" name=""cutPercentage""></p>
                <p>Offcut (L x M): <input id=""itemDimensions"" type=""text"" name=""itemDimensions""> Total Offcut Cost: $<input id=""offcutCost"" type=""text"" name=""offcutCost""> <input id=""offcutPercentage"" type=""text"" name=""offcutPercentage""></p>
            </div>
        </div>
    </div>
</div>
...
");
            EndContext();
            BeginContext(3490, 1621, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "cade18a2e0f4479e92894be221466981", async() => {
                BeginContext(3496, 1608, true);
                WriteLiteral(@"
    <div id=""scale"">
        <p>Scale</p>
        <p>2' x 1.00""</p>
